...
本文档曾取代 `14_fast-gdb空间查询优化计划.md` 中的性能优先级与验收门槛，现作为 Phase A–G 历史实施记录归档。Phase H 历史计划见 [16_spatial-query-scale-optimization-plan.md](16_spatial-query-scale-optimization-plan.md)，当前工作见 [计划 18](../18_writer跨平台测试统一与后续编辑计划.md)。
