...
| [统一访问与 GDAL/S3 路由计划](planning/24_fast-gdb统一访问与GDAL_S3路由计划.md) | Local release gates passed / external gates pending |
| [ADR-009：统一 FileGDB 访问与 GDAL/S3 路由](adr/ADR-009-unified-filegdb-routing.md) | Accepted：本地发布门禁已通过；外部矩阵待闭环；S3 仍 Experimental / Unverified |
