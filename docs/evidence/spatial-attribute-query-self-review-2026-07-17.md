...
计划仍将 Polygon、Polyline、MultiPoint、Z/M/ZM、NULL 和索引组合回退列为待补，但对应测试代码已进入分支，会误导后续验收和同步。

修复：

- 重写当前状态、测试矩阵和正式验收清单；
- 增加 `.atx` fail-closed 和三轮审核状态；
- 保持所有未实际运行的构建、CTest、consumer 和性能项为未完成。

提交：`3ddd8585bf160981ef34cbabd5bf8a6027825d10`
