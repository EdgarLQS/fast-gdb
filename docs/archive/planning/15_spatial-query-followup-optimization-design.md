...
本文档曾取代 `14_fast-gdb空间查询优化计划.md` 中的性能优先级与验收门槛，现作为 Phase A–G 历史实施记录归档。Phase H 历史计划见 [16_spatial-query-scale-optimization-plan.md](16_spatial-query-scale-optimization-plan.md)，当前工作见 [项目状态与规划](../../plan/01_项目状态与规划.md)。
