...
本说明承接 [`性能基准与回归门禁`](../quality/06_性能基准与回归门禁.md) 第 1.10 节和
`docs/plan/../plan/21_空间属性联合查询实现计划.md` 中记录的 100K full-feature 基线。
...
自检证据：
历史自审记录已移除；当前测试入口见 [`docs/quality/02_功能测试矩阵.md`](../quality/02_功能测试矩阵.md)。
